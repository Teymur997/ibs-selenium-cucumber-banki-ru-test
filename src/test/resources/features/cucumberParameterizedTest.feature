  ...
  Структура сценария:  Параметризированная проверка наличия вклада с определёнными параметрами
    ...
    * Проверить вклад банка "<bankName>" на соответствие дохода значению "<profit>":
    ...
    Примеры:
      ...
      | 1 000 000    | 6 месяцев     | Обычные вклады | Тинькофф     | ВТБ          | Открытие | Газпромбанк | Сбербанк | Со снятием           | С пополнением | С капитализацией | 14     | Тинькофф Банк | 5,63% | 182 дн. | от 27 741 ₽ |
      | 500 000      | 2 года        | Детский        | Ак Барс Банк | Банк «РОССИЯ | Сбербанк |             |          | С выплатой процентов |               |         ""       | 7      | Сбербанк      | 6,80% | 730 дн. | от 72 515 ₽ |